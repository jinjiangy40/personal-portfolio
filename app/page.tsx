...
const experiences = [
  {
    ...
    points: [
      ...
      "完成工艺 / 材料数据清洗与结构化，搭建焊接工艺问答与参数查表",
      "维护知识库更新，协助验证大模型检索与工艺推荐是否真正提效",
    ],
  },
  {
    ...
    org: "上海金仕达 · FICC 产品部",
    points: [
      "学习金融场景下的 Prompt 与智能体能力建设思路",
      "完成主流智能体平台功能对比与竞品分析",
      "参与功能复测、Bug 追踪与数据更新，把判断落在可复查证据上",
    ],
  },
  {
  ...
  },
  {
    ...
    org: "教育服务与校园市场",
    points: [
      "以校园大使形式对接数十家教育机构（启德、新东方、高顿等）",
      "覆盖语言培训与留学咨询等多种真实沟通场景",
      "累计签约 10 万元+，运营多个 200+ 人兼职社群",
    ],
  },
];
...
const campusClubs = [
  ...
  },
  {
    ...
    points: [
      ...
      "担任赛事主持 / 解说，稳住现场节奏与观众互动",
      "完成数十家机构对接，并落地留学、雅思、零食等长期赞助",
    ],
  },
  {
    org: "桌友汇",
...
const beyondItems = [
  {
    ...
    period: "",
    points: [
      "以澳科大推荐学员身份，参与哈工大跨学科 AI 应用主题科学营",
      "本校共获 13 个推荐名额；与港澳高校硕博研究生共同学习交流",
      "课题覆盖建筑 AI 模型训练优化与城市历史空间字体智能化应用",
    ],
  },
  {
    org: "树成林教育 · AI 商业实战社群",
    ...
    period: "2026.06 — 至今",
    points: [
      "系统学习 AI 在内容、求职与商业场景中的工具用法",
      "参与社群共学与交流，把能力落到可复用的实操闭环",
      "持续跟进多场景练习，补齐从工具到落地的判断",
    ],
  },
  {
    org: "1×100俱乐部",
