...
const practiceItems = [
  ...
  },
  {
    ...
    points: [
      ...
      "受邀作为树成林 AI 商业实战社群优秀成员，在探索先锋联合复盘会中分享开单经验与阶段反思",
    ],
  },
  {
    title: "校外成长",
    ...
    points: [
      ...
      "树成林教育 AI 商业实战社群学员，参与 AI 商业探索、淘宝先锋等实战任务，持续进行 AI 应用与商业化实践",
    ],
  },
];
      ...
      <div className={isMobile ? "scroll-sections" : "slides"} aria-live="polite">
        ...
        >
          ...
          <div className="deck-copy">
            ...
            <p>
              澳门科技大学人工智能本科生（2027 届）
              <br />
              关注 AI 在真实业务中的应用，持续实践从需求发现、产品原型到用户运营与商业转化。
            </p>
