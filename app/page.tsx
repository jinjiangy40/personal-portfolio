...
const experiences = [
  [
    "2026.06~2026.08",
    "湖南中南智能装备",
    "国家项目「工艺知识图谱离线编程」：清洗结构化工艺数据，搭建问答与查表，验证大模型推荐是否提效",
  ],
  ["2025.06~2025.08", "上海金仕达 · FICC 产品部", "智能体竞品分析、功能复测与 Bug 追踪，把判断落在可复查证据上"],
  ["2024.06~2024.08", "长沙顺通云科技", "官网重构测试与真实软件交付协作"],
  [
    "2023.09~至今",
    "教育服务与校园市场",
    "校园大使对接数十家教育机构（启德、新东方、高顿等）；签约 10 万元+，运营多个 200+ 人兼职社群",
  ],
];
...
const campusClubs = [
  ...
  },
  {
    ...
    points: [
      "统筹王者高校联赛澳门赛区与校级金铲铲赛（100+ 人）",
      "赛事主持 / 解说，并完成数十家机构对接与长期赞助",
    ],
  },
  {
    org: "桌友汇",
...
const beyondItems = [
  {
    ...
    period: "",
    points: [
      "澳科大推荐学员参加哈工大跨学科 AI 应用科学营（本校 13 个推荐名额）",
      "与港澳高校硕博共学；课题含建筑 AI 模型训练与城市历史空间字体智能化",
      "提升跨学科协作与科研思维",
    ],
  },
  {
